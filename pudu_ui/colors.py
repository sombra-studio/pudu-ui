...
SECONDARY_BTN_BG_COLOR = DARK_GRAY
SECONDARY_BTN_HOVER_BG_COLOR = GRAY
SECONDARY_BTN_FOCUS_BG_COLOR = GRAY
SECONDARY_BTN_PRESS_BG_COLOR = DARKER_GRAY
SECONDARY_BTN_FONT_COLOR = LIGHT_GRAY
SECONDARY_BTN_HOVER_FONT_COLOR = LIGHTER_GRAY
SECONDARY_BTN_FOCUS_FONT_COLOR = LIGHTER_GRAY
SECONDARY_BTN_PRESS_FONT_COLOR = GRAY
